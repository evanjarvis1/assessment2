...
const canWeDeliverTwo = (zipCode2) => {
    if (deliveryAreaZipCodes.includes(zipCode2)) {
        return `You are elible for delivery!`
    }
    return `Sorry we can't deliver to that address`
}
...
title1 = title1.replace(`15% Off!`, `10% Off!`)
...
let deal2 = '   This deal lasts until the end of March! '

deal2 = deal2.replace(`   This deal lasts until the end of March! `, '   This deal lasts until the end of April! ')
