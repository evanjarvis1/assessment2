...
const empOne = new Employee(`Dwight Kurt Shcrute`, ` all shifts (doesn't take vacations, sick days, or major holidays)`)
...
//CODE HERE
const manager = new Manager(`Michael Scott`, `9-12 (creative space) and 1-5 (free play)`, [`Dwight`, ` Andy`, ` Phyllis`, ` Stanley`])
